...
<?
	...
	if($ls!=0){
		$atras=$ls-$paginacion;
	?>
		<a href="<?="index.php?put=".$put."&amp;ls=0".$parametros?>"><img src="imagenes/paginator/btn_first.gif" alt="" border="0" align="left" /></a><a href="<?="index.php?put=".$put."&amp;ls=".$atras.$parametros?>"><img src="imagenes/paginator/btn_back.gif" alt="" border="0" align="left" /></a>
	<?
	}
	else{
	?>
		<img src="imagenes/paginator/btn_first_off.gif" alt="" border="0" align="left" /><img src="imagenes/paginator/btn_back_off.gif" alt="" border="0" align="left" />
	<?
	}
	if($reg_nro > 0){
	?>
	...
	?>					<div class="numeros">
						...
						foreach($array_numeros as $numero){
							?><img src="imagenes/paginator/num_bold_<?=$numero?>.gif" border="0" /><?
						}
						if($pag != $pag_nro){
						?><img src="imagenes/paginator/separator.gif" alt="" /><?
						}
						?></div>
	<?
				}
	...
	?>
						...
						$array_numeros = str_split($pag);
						foreach($array_numeros as $numero){
							?><img src="imagenes/paginator/num_<?=$numero?>.gif" border="0" /><?
						}
						?></a><?
						if($pag != $pag_nro){
						?><img src="imagenes/paginator/separator.gif" alt="" /><?
	...
	?>
		<a href="<?="index.php?put=".$put."&amp;ls=".$adelante.$parametros?>"><img src="imagenes/paginator/btn_forward.gif" alt="" border="0" align="left" /></a><a href="<?="index.php?put=".$put."&amp;ls=".$ultima_pag_ls.$parametros?>"><img src="imagenes/paginator/btn_last.gif" alt="" border="0" align="left" /></a>
	<?
	}
	else{
	?>
		<img src="imagenes/paginator/btn_forward_off.gif" alt="" border="0" align="left" /><img src="imagenes/paginator/btn_last_off.gif" alt="" border="0" align="left" />
	<?
	}
	?>
    </div>
