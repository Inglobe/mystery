<?
	...
	class ABMAddEdit extends database{
		...
		private function renderTitulos(){
			...
			<div id="title">
			  <h1>
				  <span><?=$this->categoria?></span><span class="title_separator">/</span><span class="dark_color"><?=$this->titulo?></span><span class="title_separator">/</span><span class="light_color"><?=$this->accion == "a"?"Agregar":"Modificar"?></span>
			  </h1>
			</div>
			<?
		}
		...
		private function renderSolapas(){
			...
			<div id="solapas">
				...
				if($this->accion == "m"){
					?>
					<div id="solapa_modify"><a href="index.php?put=<?=$this->nombre?>_am&abm_accion=m&id=<?=$this->id_modificar?>"><img src="skins/gris/es/solapa_modificar_on.gif" alt="Agregar" border="0" /></a></div>
					<?
				}
				?>
