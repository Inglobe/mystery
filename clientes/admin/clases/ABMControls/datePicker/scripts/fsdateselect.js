...
function FSfncCreateCalendarArea() {
	...
	if (FSblnIEwin) {
		...
		strIFRAME='<IFRAME SRC="includes/date_picker/scripts/IEFrameWarningBypass.htm" WIDTH="' + pxWidth + '" HEIGHT="' + pxHeight + '" FRAMEBORDER="0" STYLE="position:absolute; left:0px; top:0px; width:' + pxWidth + 'px; height:' + pxHeight + 'px; z-index:99"></IFRAME>';
		strSTYLE=' STYLE="position:absolute; left:0; top:0; width:' + pxWidth + 'px; height:' + pxHeight + 'px; z-index:100"';
	}
	strCalendar=strIFRAME + '<TABLE BORDER="0" CELLPADDING="1" CELLSPACING="0" ' + strSTYLE + ' ID="FSmainTable">' +
...
function FSfncWriteFieldHTML(FormName,FieldName,FieldValue,FieldWidth,ImagePath,LangID,DisableNone,UseOnClick,NotEnabled01,NotEnabled02,HposOffset,VposOffset,NotEnabled03) {
	...
	if ((document.getElementById) && (FSblnBlockBrowser==false)) {
		...
		var formFieldHTML='' +
			'<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" BGCOLOR="#FFFFFF" CLASS="FSdateSelect" ID="' + FieldName + 'FStable" WIDTH="' + FieldWidth + '" HEIGHT="20" STYLE="width:' + FieldWidth + 'px; float: left">' +
			'<TR>' +
