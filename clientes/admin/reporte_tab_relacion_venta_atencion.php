...
<div id="conteniner_tabs">
  <ul class="tabs">
    ...
    <li class="active"><a href="index.php?put=reporte_tab_relacion_venta_atencion">Relación venta - atención</a></li>
    <li><a href="index.php?put=reporte_tab_todas_variables">Todas las variables</a></li>
  </ul>
</div>
<div class="block">
  <div class="separator">
  ...
  <div style="clear:both; height:60px;">
    <form name="form_filtro" method="get">
	  <input type="hidden" name="put" value="reporte_tab_variables_generales" />
      <div class="input">
  ...
  <?php include("reporte_tab_relacion_venta_atencion.inc.php"); ?>
</div>
