  ...
  <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="backgroundTable">
    <tr>
      <td align="center" valign="top"><!-- // Begin Template Preheader \\ -->
          ...
          <tr>
            <td valign="top" class="preheaderContent"><!-- // Begin Module: Standard Preheader \ -->
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                <tr>
                  <td class="headerContent"><img src="<?=URL?>/newsletters/<?=$template?>/headers/<?=$data->post("header")?>" alt="" width="602" height="92" /></td>
                </tr>
              </table>
          ...
          <tr>
            <td align="center" valign="top"><!-- // Begin Template Body \\ -->
              ...
              <table border="0" cellpadding="20" cellspacing="0" width="600" id="templateBody">
                <tr>
                  <td width="560" colspan="3" valign="top" class="bodyContent"><?=$data->post("description",DATA_EX_FILE_TYPE_DATA)?></td>
                </tr>
              </table>
          ...
          <tr>
            <td align="center" valign="top"><!-- // Begin Template Footer \\ -->
              ...
              <table border="0" cellpadding="10" cellspacing="0" width="600" id="templateFooter">
                <tr>
                  <td valign="top" class="footerContent"><!-- // Begin Module: Standard Footer \\ --><!-- // End Module: Standard Footer \\ --></td>
                </tr>
              </table>
        ...
        <img src="<?=URL?>/newsletters/<?=$template?>/images/footer.gif" width="602" height="49" /><br /></td>
    </tr>
  </table>
</center>
</body>
