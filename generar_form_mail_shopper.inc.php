    ...
    <td bgcolor="#7F7F7F"><table width="640" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td align="left" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="20">
              <tr>
                <td><p><font face="Arial, Helvetica, sans-serif" size="3">Gracias por ponerte en contacto con <strong>Mystery Sur</strong>. Tus datos fueron ingresados a nuestra base de datos. <br />
                  <br />
                Analizaremos tu perfil y nos pondremos en contacto para que puedas desempe&ntilde;arte como mystery shopper en nuestra empresa. </font></p></td>
              </tr>
            </table></td>
        </tr>
        <tr>
