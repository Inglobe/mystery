...
<script type="text/javascript" language="javascript" src="js_library/prototype.js"></script>
<script type="text/javascript" languaje="javascript" src="js_library/scriptaculous/scriptaculous.js"></script>
<script type="text/javascript" languaje="javascript" src="js_library/scriptaculous/unittest.js"></script>
<script type="text/javascript" language="javascript" src="js_library/loom/core/core.js"></script>
<script type="text/javascript" language="javascript" src="js_library/loom/core/format.js"></script>
<script type="text/javascript" language="javascript" src="js_library/loom/ui/ui.js"></script>
<script type="text/javascript" language="javascript" src="js_library/loom/ui/tabs.js"></script>
<script type="text/javascript" language="javascript" src="js_library/loom/calendar/calendar.js"></script>
<script type="text/javascript" language="javascript" src="js_library/loom/tables/tables.js"></script>
<script type="text/javascript" language="javascript" src="js_library/loom/validation/validation.js"></script>
<script type="text/javascript" languaje="javascript" src="js_library/resources.js"></script>
    ...
    <div id="sombra_der_repeat">
      <div id="cuerpo">
		...
		<div id="cont_box_buscar">
			<div id="box_buscar">
	          <input id="txt_buscar" type="text" name="q" value="Buscar proyecto..." style="width: 320px" />
        ...
        ?>
          <li class="top"><a href="#" id="services" class="top_link"><span class="down">Sistema</span></a>
            <ul class="sub">
              ...
              <li><a href="index.php?put=proveedores_search&amp;cambiar=1">Proveedores</a></li>
              <li><a href="index.php?put=usuarios_search&amp;cambiar=1">Usuarios</a></li>
            </ul>
          </li>
          <li class="top"><a href="#" id="services" class="top_link"><span class="down">Proyectos</span></a>
            <ul class="sub">
              <li><a href="index.php?put=proyectos_search&amp;cambiar=1">Project Management</a></li>
              <li><a href="index.php?put=agenda&amp;cambiar=1">Agenda</a></li>
            <?
            if($_SESSION["id_usr"] != 6){
            ?>
              <li><a href="index.php?put=ordenes_search&amp;cambiar=1">&Oacute;rdenes de trabajo</a></li>
            <?
			}
            ?>
              <li><a href="index.php?put=tipos_proyecto_search&amp;cambiar=1">Tipos de proyecto</a></li>
              <li><a href="index.php?put=tipos_tarea_search&amp;cambiar=1">Tipos de tarea</a></li>
              <li><a href="#">Reportes</a>
                <ul>
                  <li><a href="reporte_proyectos_pendientes.php" target="_blank">Proyectos pendientes</a></li>
                  <li><a href="reporte_proyectos_abiertos.php" target="_blank">Proyectos abiertos</a></li>
                  <li><a href="index.php?put=reporte_horas_usuario">Horas por usuario</a></li>
                </ul>
              </li>
            </ul>
          </li>
        ...
        ?>
          ...
          <li class="top"><a href="index.php?put=proyectos_search" id="externo" class="top_link"><span class="">Proyectos</span></a></li>
        <?
        }
        ?>
        </ul>
