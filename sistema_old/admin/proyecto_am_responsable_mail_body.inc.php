...
<title>Ficha de alta de proyecto</title>
</head>
<body>
      ...
      <tr>
        <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; color: #666666"><p>Hola <strong>
          ...
          <p>El d&iacute;a <strong>
            <?=$fila["fecha_a_f"]?>
            </strong> se agreg&oacute; el proyecto <strong>
            <?=$fila["nombre"]?>
            </strong> en el sistema para el cliente <strong>
            <?=$fila["cliente"]?>
          </strong></p>
          <p>El tipo de proyecto es <strong>
            <?=$fila["tipo_proyecto"]?>
          ...
          <p>El material para este proyecto se encuentra en <strong>
            <?=$fila["path_server_local"]?>
          </strong></p>
          <p>El supervisor del proyecto es <strong>
