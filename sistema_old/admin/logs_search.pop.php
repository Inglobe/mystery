...
<div id="btns_sup"><a href="logs_am.pop.php?accion=a&amp;id=<?=$_GET["id"]?>"><img src="imagenes/btn_sup_add.jpg" alt="" border="0" /></a></div>
<div id="feed">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <?
				...
				while($fila = mysql_fetch_assoc($result)){
	            	...
	            	$link_borrar = "logs_procesar.pop.php?id_eliminar=".$fila["id_log_cliente"]."&amp;accion=d&amp;id=".$_GET["id"];
            ?>
              <tr class="<?=$estilo?>">
