<?
	...
	if($_GET["accion"]=="m"){
		$consulta = "SELECT * FROM logs_clientes WHERE id_contacto = ".$_GET["id_modificar"];
...
<div id="btns_sup">
  <?
				if($_GET["accion"]=="m"){
				?>
  <a href="logs_am.pop.php?accion=a&amp;id=<?=$_GET["id"]?>"><img src="imagenes/btn_sup_add.jpg" alt="" border="0" /></a>
  <?
				}
				?>
  <a href="logs_search.pop.php?accion=s&amp;id=<?=$_GET["id"]?>"><img src="imagenes/btn_sup_search.jpg" alt="" border="0" /></a></div>
<div id="feed">
  ...
  <div class="borde_bloque_izq">
    <div class="borde_bloque_der">
      <div class="cuerpo_bloque">
        <form action="logs_procesar.pop.php?accion=<?=$_GET["accion"]?>&amp;id=<?=$_GET["id"]?><?=($_GET["accion"]=="m"?"&amp;id_modificar=".$_GET["id_modificar"]:"")?>" method="post" enctype="multipart/form-data" name="form_am" id="form_am" onsubmit="return validar(this)">
		  <div class="control">
            <div class="label_add">
          ...
          <div id="btns_ok_cancel"><a href="logs_search.pop.php?id=<?=$_GET["id"]?>"><img src="imagenes/btn_cancel.jpg" alt="" border="0" /></a>
