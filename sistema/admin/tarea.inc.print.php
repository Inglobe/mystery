...
<div class="descripcion<?=($tiene_hijos?"_titulo":"")?>"><a href="<?=$href_tarea?>" class="<?=$estilo_tarea_permiso?>" title="Shopper: <?=getUsrNomById($fila["id_usuario_responsable"])?> - Autor: <?=getUsrNomById($fila["id_usuario_owner"])?>"><?=$fila["descripcion"]?></a></div>
