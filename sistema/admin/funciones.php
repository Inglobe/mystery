...
function enviarMailProyecto($id_proyecto, $ids_usuario){
	...
	foreach($ids_usuario as $id_usuario){
		...
		mail_html($fila_usuario["email"],"website@mysterysur.com.ar","Mystery Sur",$fila_parametros["email_contactenos"],$fila_usuario["nombre"].", tienes \"".$fila["nombre"]."\" a tu cargo.",$html,strip_tags($html));
	}
}
