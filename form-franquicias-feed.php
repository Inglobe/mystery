...
<div id="fondo_secciones">
  <div id="col_izq_seccion">
    <p class="texto_resaltado">Complet&aacute; el siguiente formulario y nos pondremos en contacto con Ud. <br />
    para informarle acerca de los alcances del sistema de franquicias.</p>
