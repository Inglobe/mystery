...
?>
    <div id="solapa_add"><a href="index.php?put=<?=$nombre_abm?>_am&amp;abm_accion=a"><img src="skins/<?=$abm_skin?>/<?=$idioma?>/solapa_agregar_<?
  if($accion=="a")
  	  echo "on";
  else
  	  echo "off";
?>.gif" alt="Agregar" border="0" /></a></div>
    <div id="solapa_search"><a href="index.php?put=<?=$nombre_abm?>_search&amp;abm_accion=s"><img src="skins/<?=$abm_skin?>/<?=$idioma?>/solapa_buscar_<?
  if($accion=="s")
  	  echo "on";
  else
  	  echo "off";
