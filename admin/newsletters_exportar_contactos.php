...
<table width="284" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><div id="titulo">
        <table border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td><h1>Exportar Contactos </h1></td>
          </tr>
        </table>
      </div></td>
  </tr>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="10" cellspacing="0">
        <tr>
          <td class="recuadro"><form action="newsletters_exportar_contactos_save.php" method="post" target="_blank" onsubmit="return validar(this)">
                  ...
                  <td align="right" valign="bottom"><table border="0" align="left" cellpadding="0" cellspacing="4">
                      <tr>
                        ...
                        <td><?
							...
							$id_db="id_grupo_news";
							$item_ninguno="--todos--";//ACORDARSE DE VALIDAR FORM
                ...
                <tr>
                  <td height="30" align="right" valign="bottom"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="96" align="right"><input type="image" name="enviar" src="skins/gris/es/btn_descargar.gif" /></td>
                    </tr>
                  </table>
                  </td>
                </tr>
