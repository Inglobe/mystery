    ...
    <td bgcolor="#7F7F7F"><table width="640" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td align="left" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="20">
              <tr>
                <td align="center"><p><font face="Arial, Helvetica, sans-serif" size="3">Estimado cliente, gracias por comunicarse con <strong>Mystery Sur</strong>. A la brevedad estaremos respondiendo su consulta.</font></p></td>
              </tr>
            </table></td>
        </tr>
        <tr>
